...
class InterfuserAgent(autonomous_agent.AutonomousAgent):
    ...
    def run_step(self, input_data, timestamp):
        ...
        state_data = {}
        state_data["rgb"] = rgb
        state_data["rgb_left"] = rgb_left
        state_data["rgb_right"] = rgb_right
        state_data["rgb_center"] = rgb_center
        state_data["lidar"] = (torch.from_numpy(tick_data["lidar"]).float().cuda().unsqueeze(0))
